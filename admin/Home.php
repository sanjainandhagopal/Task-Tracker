				...
				<li><a href="#">Settings</a>
					<div class = "sub1">
						...
						if($temp_row['ID'] == 1){ ?>
							...
							<li><a href="Add_dep.php">Add new department</a></li>
							<li><a href="Add_emp.php">Add New Administrator</a></li>
							<li><a href="show_dep.php">Data of HOD</a></li>
							<li><a href="show_emp.php">Data of Administrator</a></li>
						...
						?>	
							...
							<li><a href="change_email.php">Change Mail</a></li>
						</ul>
					</div>
				</li>
...
<ol class="list-group list-group-numbered">
  <li class="list-group-item d-flex justify-content-between align-items-start">
    <div class="ms-2 me-auto">
      <div class="fw-bold">Today's Deadline : </div>
  ...
  <li class="list-group-item d-flex justify-content-between align-items-start">
    <div class="ms-2 me-auto">
      <div class="fw-bold">2nd day's Deadline: </div>
  ...
  <li class="list-group-item d-flex justify-content-between align-items-start">
    <div class="ms-2 me-auto">
      <div class="fw-bold">3rd day's Deadline : </div>
