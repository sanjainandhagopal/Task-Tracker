...
<head>
	...
	<title>Events</title>
	<link rel="stylesheet" type="text/css" href="../CSS/table_body(css).css">
	<link rel="stylesheet" type="text/css" href="../CSS/bar(css).css">
	<link rel="stylesheet" type="text/css" href="../CSS/Alt_click(css).css">
		...
		<div class="menu-bar">
			...
			<ul>
				...
				<li><a href="#">View</a>
					<div class="sub1">
						<ul>
							<li><a href="self(view).php">Self Task</a></li>
							<li><a href="Task_viewer.php">One Time Task</a></li>
